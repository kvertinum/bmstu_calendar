...
from src.exceptions.base import DetailedAiogramTemplateError


class UnknownKeyboardButtonPropertyError(DetailedAiogramTemplateError):
    def __init__(
        self,
...
class NotEnoughArgsToCreateButtonError(DetailedAiogramTemplateError):
    def __init__(
        self,
...
class TooManyArgsToCreateButtonError(DetailedAiogramTemplateError):
    def __init__(
        self,
        provided_args: Sequence[str],
        max_args_amount: int,
...
class PaymentButtonMustBeFirstError(DetailedAiogramTemplateError):
    def __init__(self) -> None:
        super().__init__(message="Payment button must be first in keyboard")


class WrongKeyboardSchemaError(DetailedAiogramTemplateError):
